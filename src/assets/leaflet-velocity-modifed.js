...
L.Control.Velocity = L.Control.extend({
  ...
  _onMouseMove: function _onMouseMove(e) {
    var self = this;
    var currentMap = this.options.leafletVelocity._map;
    ...
    if (gridValue && !isNaN(gridValue[0]) && !isNaN(gridValue[1]) && gridValue[2] && gridValue[3]) {
      ...
      var temperatureCelsius = (gridValue[3] - 273.15).toFixed(1).concat("\xB0C");
      var speed = (self.vectorToSpeed(gridValue[0], gridValue[1], this.options.speedUnit).toFixed(2) + " ").concat(this.options.speedUnit);
      htmlOut = "<strong> ".concat(this.options.velocityType, " ").concat(this.options.directionString, ": </strong> ").concat(deg.toFixed(2), "\xB0")
      .concat(cardinal, ", <strong> ").concat(this.options.velocityType, " ").concat(this.options.speedString, ": </strong> ").concat(speed)
      .concat(", <strong>Temp: </strong>").concat(temperatureCelsius);
      ...
      currentMap.closePopup(this.popup)
  ...
  _onMouseOut: function _onMouseOut(e) {
    this.options.leafletVelocity._map.closePopup(this.popup)
  }
});
L.Map.mergeOptions({
...
var Windy = function Windy(params) {
  ...
  var bilinearInterpolateVector = function bilinearInterpolateVector(x, y, g00, g10, g01, g11) {
    ...
    var temp = g00[2] * a + g10[2] * b + g01[2] * c + g11[2] * d;
    return [u, v, Math.sqrt(u * u + v * v), temp];
  };
